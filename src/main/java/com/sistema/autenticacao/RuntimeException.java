...
public class RuntimeException{
    ...
    static void ErroSenha(Password senha){
        ...
        if(!senha.getSenha().contains("!") && !senha.getSenha().contains("@") && !senha.getSenha().contains("#") && !senha.getSenha().contains("#")){
            System.out.println("A senha deve conter pelo menos um caracter especial, incluindo '!' '@' '#' '$'");
        }

        if(!senha.getSenha().contains("0") && !senha.getSenha().contains("1") && !senha.getSenha().contains("2") && !senha.getSenha().contains("3")
        && !senha.getSenha().contains("4") && !senha.getSenha().contains("5") && !senha.getSenha().contains("6") && !senha.getSenha().contains("7")
